package com.elf.soap.common.xml;
...
public interface Nodelet {
	 ...
	 * 
	 * @param node
	 *            The node represents any XML node that can be registered under
	 ...
	 *            <li>Element - This is the most flexible type. You can get the node content
	 *            and iterate over the node's child nodes if neccessary. This is useful where a
	 *            single XPath registration cannot describe the complex structure for a given
	 *            XML stanza.
	 *            </ul>
	 * 
	 */
