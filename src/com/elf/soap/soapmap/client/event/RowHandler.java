package com.elf.soap.soapmap.client.event;

/**
 * Event handler for row by row processing.
 * <p/>
 * The RowHandler interface is used by the SqlMapSession.queryWithRowHandler() method.
 * Generally a RowHandler implementation will perform some row-by-row processing logic in cases
 * where there are too many rows to efficiently load into memory.
 * <p/>
 * Example:
 * 
 * <pre>
