 ...
 * <p/>
 * <b>NOTE:</b> There is no need to implement this. The implementation will be passed into the
 * TypeHandlerCallback automatically.
 */
public interface ResultGetter {
	 ...
	 * May be <code>null</code> in which case the <code>getColumnIndex</code> method should be
	 * used.
	 * 
	 ...
	 * Only use this method if the value returned from <code>getColumnName</code> is null.
	 * 
