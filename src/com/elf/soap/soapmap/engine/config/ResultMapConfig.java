...
public class ResultMapConfig {
	...
	ResultMapConfig(SoapMapConfiguration config, String id, Class resultClass, String groupBy, String extendsResultMap,
		String xmlName) {
		this.config = config;
	...
	public void setDiscriminator(String columnName, Integer columnIndex, Class javaClass, String jdbcType,
		...
		if (typeHandlerImpl != null) {
			...
			handler =
				config.resolveTypeHandler(client.getDelegate().getTypeHandlerFactory(), resultMap.getResultClass(), "",
