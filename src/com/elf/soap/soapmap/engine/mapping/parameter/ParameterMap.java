...
import com.elf.soap.soapmap.engine.type.JdbcTypeRegistry;
...
public class ParameterMap {
	...
	public ParameterMap(SoapMapExecutorDelegate delegate) {
	...
	public void setParameterMappingList(List parameterMappingList) {
		this.parameterMappings =
			(ParameterMapping[]) parameterMappingList.toArray(new ParameterMapping[parameterMappingList.size()]);
