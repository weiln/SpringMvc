...
public class EnhancedLazyResultLoader {
	 ...
	 */
	public EnhancedLazyResultLoader(SoapMapClientImpl client, String statementName, Object parameterObject,
		Class targetType) {
	...
	private static class EnhancedLazyResultLoaderImpl implements InvocationHandler {
		...
		protected SoapMapClientImpl client;
		 ...
		 *            - the type we are putting data into
		 */
		public EnhancedLazyResultLoaderImpl(SoapMapClientImpl client, String statementName, Object parameterObject,
			Class targetType) {
			this.client = client;
