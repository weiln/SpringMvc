...
public interface ResultObjectFactory {
	 ...
	 * <li>When processing the output parameters of a stored procedure - to create instances of
	 * OUTPUT parameters</li>
	 * <li>When processing a nested select - to create instances of parameter objects on the
	 * nested select</li>
	 * <li>When processing result maps with nested result maps. iBATIS will ask the factory to
	 * create an instance of the nested object. If the nested object is some implementation of
	 * <code>java.util.Collection</code> then iBATIS will supply default implementations of the
	 * common interfaces if the factory chooses not to create the object. If the embedded
	 * object is a <code>java.util.List</code> or <code>java.util.Collection</code> the default
	 * behavior is to create an <code>java.util.ArrayList</code>. If the embedded object is a
	 * <code>java.util.Set</code> the default behavior is to create a
	 * <code>java.util.HashSet</code>.</li>
	 * </ul>
	 * 
