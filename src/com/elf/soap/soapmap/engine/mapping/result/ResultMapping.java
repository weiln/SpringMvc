...
public class ResultMapping {
	...
	/**
	 * Getter for the name of the column to check for null before instantiating a nested
	 * resultMapping value
	 * 
	 * @return - the null substitution
	 */
	...
	/**
	 * Setter for the name of the column to check for null before instantiating a nested
	 * resultMapping value
	 * 
	 * @param notNullColumn
	 *            - the column name
