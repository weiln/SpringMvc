...
public class IterateContext implements Iterator {
	...
	public IterateContext(Object collection, SoapTag tag, IterateContext parent) {
		this.parent = parent;
		this.tag = tag;
	 ...
	 *            The tag to set.
	 */
	public void setTag(SoapTag tag) {
		this.tag = tag;
	}
	...
	/**
	 * Replaces value of a tag property to match it's value with current iteration and all
	 * other iterations.
	 * 
	 * @param tagProperty
	 *            the property of a TagHandler.
	 * @return A Map containing the modified tag property in PROCESS_STRING key and the index
	 *         where the modification occured in PROCESS_INDEX key.
	 */
	...
	/**
	 * Adds index value to the first found property matching this Iteration starting at index
	 * startIndex.
	 * 
	 * @param input
	 *            The input String.
