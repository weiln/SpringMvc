...
import com.elf.soap.soapmap.engine.type.SimpleDateFormatter;
...
public abstract class ConditionalTagHandler extends BaseTagHandler {
	...
	public abstract boolean isCondition(SoapTagContext ctx, SoapTag tag, Object parameterObject);
	...
	public int doStartFragment(SoapTagContext ctx, SoapTag tag, Object parameterObject) {
		...
		if (isCondition(ctx, tag, parameterObject)) {
			...
			return SoapTagHandler.SKIP_BODY;
		}
	}
	...
	protected long compare(SoapTagContext ctx, SoapTag tag, Object parameterObject) {
	 ...
	 * @param tag
	 */
	protected String getResolvedProperty(SoapTagContext ctx, SoapTag tag) {
